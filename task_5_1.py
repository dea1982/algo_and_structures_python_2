"""
Задание 1. Пользователь вводит данные о количестве предприятий, их наименования и
...
for i in range(ENTERPRISE_COUNT):
    ...
    quarters = [float(j) for j in input(
...
if ENTERPRISE_COUNT == 1:
    print(
        f'Для анализа передано 1 предприятие: {ENTERPRISES[0].name}. Eго годовая прибыль: {ENTERPRISES[0].year}')

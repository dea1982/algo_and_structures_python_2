"""
Задание 1. Подсчитать, сколько было выделено памяти под переменные в ранее
...
# Тесты выполнены на 64-разрядной Win 10 Pro версии 1909
# Python 3.8.1 [MSC v.1916 64 bit (AMD64)] on win32
...
# ВЫВОД: Использование дополнительных переменных занимает
# в памяти больше места, но их наличие порой облегчает
# читабельность кода. Сччитаю, что хорошим компромиссом этих критериев
# будет вариант 2.


# ****************************************************
# Для проверки написанной функции на других типах перем
...
# Переменные:  [5, 0, 10, [0, 0, 2, 5, 4, 2, 2, 0, 0, 3],
# 3, 4, 3, [0], {0: 4, 2: 3, 5: 1, 4: 1, 3: 1}]
# ['MAX_ITEM', 'MIN_ITEM',  'SIZE', 'array',
# 'item', 'max_count', 'num', 'num_max_count', 'numbers']

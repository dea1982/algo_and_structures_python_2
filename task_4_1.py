...
# И даже на самом маленьком размере входных данных алгоритм работает
# значительно медленнее, чем div_count()
...
# Так как он выполняется практически за константное время, несильно завися
